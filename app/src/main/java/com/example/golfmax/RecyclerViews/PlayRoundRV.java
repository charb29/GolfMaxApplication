...
import com.example.golfmax.Activities.Front9Activity;
...
public class PlayRoundRV extends RecyclerView.Adapter<PlayRoundRV.MyViewHolder> {
    ...
    public PlayRoundRV(Context context, List<Course> courseList) {
    ...
    @NonNull
    @Override
    public PlayRoundRV.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.play_round_rv_item, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PlayRoundRV.MyViewHolder holder, int position) {
        ...
        public MyViewHolder(View itemView) {
            ...
            textViewCourseName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, Front9Activity.class);
