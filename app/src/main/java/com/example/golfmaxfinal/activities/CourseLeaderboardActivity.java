...
import com.example.golfmaxfinal.backend.ScoreRepository;
...
public class CourseLeaderboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreRepository.setBinding(binding);
        long courseId = getCourseId(CourseListRV.courseName);
        course.setCourseName(CourseListRV.courseName);
